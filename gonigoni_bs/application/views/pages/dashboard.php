                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <img src="<?php echo base_url();?>/assets/images/faces/face1.jpg" class="mr-2" alt="image">
                            David Grey
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <img src="<?php echo base_url();?>/assets/images/faces/face2.jpg" class="mr-2" alt="image">
                            Stella Johnson
                          </td>
                          <td>
                            High loading time
                        ...
                        <tr>
                          <td>
                            <img src="<?php echo base_url();?>/assets/images/faces/face3.jpg" class="mr-2" alt="image">
                            Marina Michel
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <img src="<?php echo base_url();?>/assets/images/faces/face4.jpg" class="mr-2" alt="image">
                            John Doe
                          </td>
                          <td>
